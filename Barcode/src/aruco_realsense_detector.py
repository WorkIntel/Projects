...
#     sys.exit(0)
  ...
  this_aruco_dictionary = cv2.aruco.getPredefinedDictionary(cv2.aruco.DICT_6X6_250) #cv2.aruco.Dictionary_get(ARUCO_DICT[desired_aruco_dictionary])
  ...
  while(True):
    ...
    (corners, ids, rejected) = cv2.aruco.detectMarkers(gray, this_aruco_dictionary, parameters=this_aruco_parameters)
