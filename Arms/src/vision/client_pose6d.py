...
class MsgPoseData:
    ...
    def __init__(self, objId = 0, objP = np.array([0,0,0,0,0,0]), objQ = 0):
        self.msgId          = 1
    ...
    def setPose(self, objId = 0, objP = np.array([0,0,0,0,0,0]), objQ = 0):
...
class ClientPose6D:
    ...
    def detect(self, objectId = 1, robotPose = np.array([0,0,0,0,0,0])):
        # sending request
        self.msgTx.setPose(objectId,robotPose,0)
