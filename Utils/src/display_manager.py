...
class TestDisplayManager(unittest.TestCase): 
    ...
    def test_Create(self):
        cfg         = ConfigManager(r'D:\Cust\ITPAero\Objects\Trajectory_Stereo_01')
    ...
    def test_ShowCameraAndPixelRay(self):
        # test gripper placement
        cfg                 = ConfigManager(r'D:\Cust\ITPAero\Objects\TurbineStereo_01')
        d                   = DisplayManager(cfg)
        d.Init()
    ...
    def test_ShowCameraGripperPoints(self):
        # actual use case from stereo manageer
        cfg                 = ConfigManager(r'D:\Cust\ITPAero\Objects\TrajectoryStereo_01')
        d                   = DisplayManager(cfg)
    ...
    def test_ShowCameraGripperHangers(self):
        # actual use case from hangers manageer
        cfg                 = ConfigManager(r'D:\Cust\Inditex\Objects\Inditex-Hanger-02')
        d                   = DisplayManager(cfg)
    ...
    def test_TestInitShowCameraBaseTool(self):
        # actual use case from hangers manageer
        cfg                 = None #ConfigManager(r'D:\Cust\Inditex\Objects\Inditex-Hanger-02')
        d                   = DisplayManager(cfg)
...
#    print(__doc__)
#    cfg         = ConfigManager(r'D:\Cust\RobotAI\MouseBox-24Labels')
#    d           = DisplayManager(cfg)
#    #d.TestScene(cfg)
#    d.TestSceneNew()
#    d.Finish()
